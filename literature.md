...
<img src="https://mushan-guan.github.io/img6.png" style="zoom:60%;" >
...
缺血性脑卒中的恢复过程涉及中枢神经系统与浸润性免疫细胞之间的动态相互作用。外周免疫细胞与脑内常驻的小胶质细胞在空间位点上存在竞争，但目前尚不清楚如何调节这种平衡会对卒中恢复产生何种影响。在本研究中，我们使用 PLX5622 在雄性小鼠短暂性大脑中动脉闭塞（tMCAO）模型中创造外周免疫细胞的空间位点，从而改变浸润免疫细胞与常驻小胶质细胞之间的竞争格局。我们发现，在卒中早期阶段抑制小胶质细胞可以促进长期功能恢复。该干预措施增强了**一类具有修复特性的单核细胞来源的巨噬细胞亚群**（repair-related macrophages, **RAMf**），该亚群表现出高表达 GPNMB 和 CD63、增强的脂质代谢以及促血管生成活性。将 RAMf 移植至中风小鼠体内可改善白质完整性并促进血管修复。我们进一步鉴定出 Mafb 是调控 RAMf 修复性表型的关键转录因子。这些发现强调了优化免疫细胞动态，以促进中风后康复的潜在治疗策略。

C57BL/6J MCAO小鼠PLX5622连续小胶清除7天，然后常规喂养到造模后第35天做行为学与梗死体积检测；

C57BL/6J MCAO小鼠PLX5622连续小胶清除5天，第5天确认清除效率，进行脑、外周血细胞单细胞测序、流式检查免疫细胞比例、检测梗死体积、脑白质完整性、血管新生情况，单细胞测序重点关注巨噬细胞、单核细胞；

C57BL/6J MCAO小鼠PLX5622连续小胶清除7天，然后常规喂养到造模后第14天脑细胞单细胞测序、检测梗死体积、脑白质完整性、血管新生情况，单细胞测序重点关注少突胶质细胞及其前体细胞、血管内皮细胞、小胶质细胞；

C57BL/6J MCAO小鼠PLX5622连续小胶清除7天，然后常规喂养到造模后第14天脑CD45high、外周血单细胞测序，重点关注巨噬细胞、单核细胞，发现RAMf并流式验证，轨迹Monocle3 & FateID、打分AUCell、细胞通讯InterCellDB、转录因子分析ARCHS4 & SCENIC；

Mafb-siRNA 骨髓来源巨噬细胞体外吞噬髓鞘能力减弱；

慢病毒过表达骨髓来源巨噬细胞Mafb然后bulk RNA测序，发现和RAMf基因表达类似，同时小鼠移植验证；

CCR2-GFP MCAO小鼠PLX5622连续小胶清除5天，第5天流式、染色验证RAMf的身份，使用clodronate liposomes清除单核细胞或CCR2-KO小鼠确认RAMf的外周单核起源，同时第5天做脂质组学确认RAMf对脂代谢的影响；

C57BL/6J MCAO小鼠在第5天接受RAMf移植在第14天取样发现促进髓鞘再生、白质完整性、血管重建；

老年MCAO小鼠第14天脑单细胞测序，挑出老年小鼠的巨噬细胞与年轻小鼠的巨噬细胞进行比较分析，发现老年小鼠也存在RAMf，并且可以通过早期小胶清除增加RAMf比例
...
<img src="https://mushan-guan.github.io/img7.png" style="zoom:60%;" >
...
<img src="https://mushan-guan.github.io/img9.png" style="zoom:60%;" >
...
<img src="https://mushan-guan.github.io/img1.jpg" style="zoom:33%;" >



<img src="https://mushan-guan.github.io/img2.png" style="zoom:70%;" >
...
DNA甲基化调控涉及多个层级的染色质相互作用，这一过程需要染色质重塑蛋白如HELLS的参与。在本研究中，我们构建了HELLS和 DNA甲基转移酶3A与3B（DNMT3A/B） 敲除的人类多能干细胞，并提供了结合WGBS与ATAC-seq的端到端（telomere-to-telomere, T2T）基因组图谱。我们发现，敲除HELLS会诱导DNA甲基化的广泛丧失，其模式有别于DNMT敲除，特别是在端/着丝粒卫星重复序列上表现明显，这些区域已被T2T基因组图谱明确界定。然而，HELLS对于局部增强子重塑及干细胞分化为三种胚层的潜能似乎是非必需的。综上，我们的结果进一步澄清了HELLS在人类细胞中的基因组作用靶点及其功能角色。

背景介绍：HELLS 是 SNF2解旋酶家族 中一个高度保守的成员，该家族通过ATP水解来重塑染色质结构，包括移动、移除或替换核小体。HELLS 具体与 DNMT3A 与 DNMT3B 的相互作用有关，参与新生DNA甲基化的过程。此外，在人类癌细胞系中的研究也表明，HELLS可能通过在复制叉与UHRF1的相互作用来维持DNA甲基化水平。在小鼠中，敲除HELLS会导致围产期致死，同时伴随DNA甲基化水平下降，这被认为会影响基因组稳定性。体外实验还表明，HELLS能够促使核小体位置改变，从而潜在地为DNMTs提供更好的DNA结合通路。尽管关于HELLS在小鼠中的研究已有较多，但在人类细胞中的研究仍主要依赖于位点特异性探针芯片或限制酶结合亚硫酸氢盐测序的方式，缺乏对整体甲基化图谱的全面认识。HELLS 的突变也与ICF综合征（免疫缺陷、着丝粒不稳定和面部异常综合征）有关，该病表现为1号、6号和19号染色体的特定着丝粒卫星重复区域的低甲基化。值得注意的是，人类与小鼠的着丝粒结构差异显著：人类着丝粒和近着丝粒区域由多种卫星家族的复杂重复序列组成，而小鼠则主要包含简单的“主”与“次”卫星重复。



着丝粒/近着丝粒区域的T2T图谱：随着人类**T2T（端到端）基因组计划**的推进，我们如今可以全面观察 **着丝粒/近着丝粒卫星重复序列（CenSat）** 的结构，这些区域包含了富含卫星序列的核心区域以及上下游序列，例如**短臂远端的常染色体区域**。尽管这些区域并非严格意义上的近着丝粒，但它们主要由富集于其他染色体近着丝粒区域的卫星家族构成。

- **活性α卫星（aSat）** 是唯一与功能性着丝粒直接相关的卫星类型，它们由171 bp的串联重复单元形成更高阶重复（HOR）结构，参与动粒形成与非编码RNA转录。
- **非活性α卫星** 虽与aSat结构类似，但不具备动粒结合能力，常被结构上多样的α卫星变异所包围。
- **β卫星（bSat）** 由68 bp重复单元组成多聚HOR结构；
- **γ卫星（gSat）** 由高度变异的220 bp重复单元组成，形成2–10 kb的簇；
- **HSat1A与HSat1B** 属于高AT含量卫星，形成交替的42 bp高阶重复，分别分布于**3、4、13号染色体**和**Y染色体**；
- **HSat2和HSat3** 来源于五聚体重复，是人类基因组中最大的卫星阵列，主要位于**1、9和16号染色体**；
- T2T图谱还首次解析了“其他着丝粒卫星”以及连接不同卫星家族的“过渡区域”，共计为基因组组装新增了约 **1.2 Mb的新序列信息**。

借助T2T参考组装，结合 **全基因组亚硫酸氢盐测序（WGBS）**，我们如今能更有力地研究人类基因组的 **DNA甲基化模式**，尤其是在此前无法有效解析的区域。



全基因组亚硫酸氢盐测序（WGBS）处理流程: 原始测序数据首先使用 **cutadapt**（版本2.4）进行接头序列及低质量序列的修剪，使用参数包括：`--quality-cutoff 20 --overlap 5 --minimum-length 25`，并对两端的Illumina TruSeq接头进行去除。随后，对**第一读段（read 1）\**的\**5'端修剪10个碱基**，**3'端修剪5个碱基**；对**第二读段（read 2）\**的\**5'端修剪15个碱基**，**3'端修剪5个碱基**。修剪后的读段使用 **BSMAP（版本2.90）** 对齐至人类基因组（chm13版本），采用以下参数：`-v 0.1 -s 16 -q 20 -w 100 -S 1 -u -R`【参考文献52】。重复序列使用 **GATK（版本4.1.4.1）** 中的 “MarkDuplicates” 命令去除，参数如下：`--VALIDATION_STRINGENCY = LENIENT --REMOVE_DUPLICATES = true`。甲基化水平调用使用 **MOABS 软件包（版本1.3.2）** 中的 **mcall** 工具完成（采用默认参数）。所有分析仅限于常染色体区域（autosomes），并仅保留**覆盖深度在10到150之间的CpG位点**用于下游分析。此外，对齐后的 BAM 文件还经过筛选，仅保留**唯一比对的读段**（bitwise flag 不包含256）。这些唯一比对的读段同样进行了后续处理，包括使用 mcall 调用甲基化水平、进行覆盖度过滤（10–150），并限制于常染色体后，才进入下游分析流程。
...
[img](https://github.com/mushan-guan/mushan-guan.github.io/blob/main/paper_pic/HELLS/img4.png)
...
laser Doppler and laser speckle to monitor  regional cerebral blood flow (rCBF) of the parietal cortex in mice

infarct volume

T2 weightedmagneticresonanceimaging(MRI)
...
sensorimotor functions: Garcia score test, rotarod test, adhesive removal test

cognitive: Morris water maze

foot fault test

grip strength

细胞周期检查: DyeCycle staining

electrophysiology was then used to ex amine the long- term functional integrity of white matter manifested as the nerve conduction by evoking and recording the compound action  potentials (CAPs) in the corpus callosum. The results showed that  tFCI decreased the amplitudes of the N1 and N2 segments, represent ing the fast conduction of myelinated axons and the slow conduction  of unmyelinated axons, respectively.
...
M1型小胶质细胞具有强大的吞噬作用，主要分泌促炎因子，发挥促炎功能，引起细胞凋亡及继发损伤，过度活化的M1型小胶质细胞具有明显的神经毒性作用。

M1巨噬细胞/小胶质细胞: CD86, CD16, CD32, MHC-Ⅱ, iNOS, IL-1β, IL-6, TNF-α, CCL-3, CCL-5

M2型小胶质细胞又分为M2a、M2b、M2c 3种亚型，可分泌抗炎细胞因子，在血管生成、促进炎症修复方面起重要作用。

M2巨噬细胞/小胶质细胞: CD206, CD163, Msr1, Arg-1, Fizz-1, IL-10, YM1/2, TREM2, TGF-β, CCL22
...
CSF1R抑制剂类小胶质细胞清除剂: PLX5622, PLX3397

小胶质细胞清除: CXCR1creER:iDTR transgenic mice and diphtheria toxin

巨噬细胞清除剂: clodronate liposomes

Aβ的荧光染料: Methoxy-X04、thioflavine-S、Thiazine Red

days post-injury (dpi)

cell survival: Annexin V/PI

cell viability: MTT assay

白质染色: SMI32 (a neurofilament marker) and MBP (a key myelin protein)

SMI32/MBP ratio越低代表越好

新生少突胶质细胞染色: APC+ BrdU+ 

新生少突胶质细胞前体染色: PDGFRα+ BrdU+

新生血管染色: CD31+ BrdU+ ZO-1+
...
myelination相关基因: Ndrg1, Degs1, Mag, Mog, Plp1, Cnp, Igf1, Gjc2, Afdn, Trf

angiogenesis相关基因: Pkm, S100a1, Pamp2, Itgb1, Grn, Lgals3

pro angiogenic phenotype: Igf1, Grn, Lgals3, Ang, Ccl2, Pdgfra, Vegfb, Pf4, Anpep, Flt1, Hgf

immediate early genes: Egr1, Jund, Klf2
...
myelin debris phagocytosis: Trem2

lipid storage in lipid droplets: Plin2, Plin3, Soat1

lipid storage: BODIPY

lipid hydrolysis: Nceh1, Lpl, Pla2g7

lipid metabolism regulation: Nr1h3

lipid efflux: Abca1

lipid transport: Apoe, Apoc1, Apoc2, Npc1
...
lysophosphatidylcholine (LPE)

cholesterolester (ChE)
...
macrophages: CD45+CD11b+F4/80+Ly6G−CD11C−

neutrophils: CD45+CD11b+F4/80− 

oligodendrocytes: CD45+CD11b−O4+
